...
This is the supported automatic-TLS Traefik variant for Remnawave Traffic Audit release `2.7.4-traffic-audit.4`. It uses the pinned official `traefik:v3.7.5` image and the existing `remnawave-network` created by the panel Compose project.
